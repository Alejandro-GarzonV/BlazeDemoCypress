...
const gherkinDocumentsAstIdMaps = createWeakCache((key) => {
    const astIdMap = new Map();
    for (const node of (0, ast_helpers_1.traverseGherkinDocument)(key)) {
...
function createMissingStepDefinitionMessage(context, text) {
