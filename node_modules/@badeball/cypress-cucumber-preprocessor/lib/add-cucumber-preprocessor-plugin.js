...
async function beforeRunHandler(config) {
    ...
    const messagesPath = (0, helpers_1.ensureIsAbsolute)(config.projectRoot, preprocessor.messages.output);
...
async function afterRunHandler(config) {
    ...
    if (preprocessor.json.enabled) {
        const jsonPath = (0, helpers_1.ensureIsAbsolute)(config.projectRoot, preprocessor.json.output);
    ...
    if (preprocessor.html.enabled) {
        const htmlPath = (0, helpers_1.ensureIsAbsolute)(config.projectRoot, preprocessor.html.output);
